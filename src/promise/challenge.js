...
/*fetchData(`${API}/products`)
  ...
  /*
  💾 𝗖𝗹𝗮𝘀𝗲 #𝟭3: 𝗙𝗲𝘁𝗰𝗵 13/𝟮𝟭 💾 . Por medio de ++Fetch++ se puede realizar peticiones HTTP asíncronas de JavaScript (JS) con promesas. La API Fetch proporciona una interfaz JS más cómoda para acceder y manipular; fetch() es un método global. . 🛠️ Para poder usar fetch, primero tenemos que instalarlo: .
